...
import { MdErrorOutline, MdOutlineSecurity, MdDevices, MdCastConnected, MdKeyboardArrowRight, MdSettings } from "react-icons/md";
      ...
      <div className="grid-container">
        ...
        <div className="card alert">
          <h3 className="cardheader">
            <MdErrorOutline className="icon" style={{ color: "#8c0500" }} />
            Alerts
          </h3>
        ...
        <div className="general-settings">
          <h3><MdSettings className="icon" />General settings</h3>
