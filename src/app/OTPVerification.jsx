...
const OTPVerification = () => {
    ...
    // Get phone number from localStorage or location.state
    const storedPhone = localStorage.getItem("phoneNumber");
    const phoneNumber = location.state?.phone || storedPhone || "Placeholder Number";
        ...
        <div className="RSUserSignUpLogInFU">
            ...
            <div className="right-section">
                ...
                <p className="subtitle">
                    A verification code has been sent to <br /><b>{phoneNumber}</b>
                </p>
