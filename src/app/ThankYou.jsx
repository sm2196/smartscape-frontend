        ...
        <div className="RSUserSignUpLogInFP">
            ...
            <div className="right-section-fp">
                ...
                <div >
                    ...
                    <p className="subtitle-ty">Your documents are currently being reviewed. You will receive an email shortly if everything is in order, and your account will be cleared for the next steps. We appreciate your patience!</p>
                </div>
                </form>
